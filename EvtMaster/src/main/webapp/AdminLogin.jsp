    ...
    <div class="container mx-auto flex justify-center items-center h-screen">
        <div class="w-full max-w-sm p-4 bg-white rounded shadow-md">
            ...
            <div class="mb-4 text-center">
                <button class="text-blue-500 hover:underline"><a href="SPLogin.jsp">Login As Service Provider</a></button>
            </div>
            <div class="text-center">
                <button class="text-blue-500 hover:underline"><a href="EventPlannerLogin.jsp">Login As Event Planner</a></button>
            </div>
        </div>
    </div>
</body>
