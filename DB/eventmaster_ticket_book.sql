...
CREATE TABLE `ticket_book` (
  ...
  KEY `UserID` (`UserID`),
  CONSTRAINT `ticket_book_ibfk_1` FOREIGN KEY (`TicketID`) REFERENCES `ticket` (`TicketID`),
  CONSTRAINT `ticket_book_ibfk_2` FOREIGN KEY (`UserID`) REFERENCES `user` (`userID`)
...
INSERT INTO `ticket_book` VALUES (2,3,'2023-10-22',1),(6,3,'2023-10-22',1);
